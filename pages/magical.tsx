...
const Magical: NextPage = () => {
    return (
        <Box css={{ height: "100vh", width: "100vw" }}>
            ...
            {/* <Stack.Root width={"screen"} height={"screen"} axis={"vertical"}>
                <Stack.Item width={"2fr"} height={"200px"} css={{ backgroundColor: "$blue6" }}/>
                <Stack.Item css={{ backgroundColor: "$blue7" }}/>
                <Stack.Item css={{ backgroundColor: "$blue8" }}/>
                <Stack.Item css={{ backgroundColor: "$blue9" }}/>
            </Stack.Root> */}
            ...
            <Box 
                ...
                <Box css={{ overflow: "hidden", gap: 10, backgroundColor: "$blue4", height: "120px", display: "flex" /* asStack */,  flexDirection: "row", alignItems: "center", justifyContent: "center"  }}>
                ...
                <Box css={{ overflow: "scroll", gap: 10, backgroundColor: "$green4", flexGrow: 1, flexShrink: 1, height: "200px", display: "flex" /* asStack */,  flexDirection: "column" }}>
